...
public class MasterListUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_master_list_upload);
        ...
        if (receivedString.equals("ths")){
            sub.setText("Upload Master List (THS 103)");
        }
       else if (receivedString.equals("ge")){
            sub.setText("Upload Master List (GE 08CS)");
        }
                ...
                if (a.equals("1")) {
                    ...
                    if (!photos.isEmpty()) {
                        for (Bitmap bitmap : photos) {
                            ...
                            Log.d("encodedImg", encodeImg);
                            uploaddatatodb();
//                            OnMasterList(v);
                        }
                    } else {
                        Toast.makeText(MasterListUpload.this, "No selected photos!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void uploaddatatodb() {
        ...
        url = "https://geloyujin.000webhostapp.com/masterlist_ths.php";
